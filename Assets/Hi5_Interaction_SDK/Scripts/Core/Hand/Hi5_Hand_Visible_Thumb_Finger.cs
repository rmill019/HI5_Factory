...
namespace Hi5_Interaction_Core
{
    public class Hi5_Hand_Visible_Thumb_Finger : Hi5_Hand_Visible_Finger
    {
        ...
        internal bool IsMoveTowardHand()
        {
            ...
            if (records.Length == Hi5_Interaction_Const.ObjectPinchRecordPostionCount)
            {
                Hi5_Position_Record pre = records[Hi5_Interaction_Const.ObjectPinchRecordPostionCount - 3];
                Hi5_Position_Record back = records[Hi5_Interaction_Const.ObjectPinchRecordPostionCount - 1];
        ...
        //internal protected override void ChildRotaitionZ(float angle, Hi5_Glove_Finger_bone_Type boneType)
        //{

        //}

        //internal protected override void ChildRotaitionY(float angle, Hi5_Glove_Finger_bone_Type boneType)
        //{
        //    {
        //        if (boneType != Hi5_Glove_Finger_bone_Type.EFour)
        //        {
        //            mBoneCollider[boneType].ChangeFingerByParentCollision(-angle);
        //            if ((Hi5_Glove_Finger_bone_Type)(boneType + 1) != Hi5_Glove_Finger_bone_Type.EFour)
        //            {
        //                Hi5_Glove_Finger_bone_Type child_bone_type = boneType + 1;
        //                ChildRotaitionY(angle, child_bone_type);
        //            }
        //        }
        //    }
        //}
