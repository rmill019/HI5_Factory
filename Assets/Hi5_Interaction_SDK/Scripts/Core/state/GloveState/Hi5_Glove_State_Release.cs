...
//            List<int> pinchs;
//            int ObjectId = -1;
//            bool isPinch = Hand.mState.mJudgeMent.IsPinch(out pinchs, out ObjectId);
//
//            //ruige 添加抓取一个判断
//            if (isPinch)
//            {
...
//                {
//					
//                    Hi5_Interaction_Message.GetInstance().DispenseMessage(Hi5_MessageKey.messagePinchObject, pinchs, Hand, ObjectId);
//                    //isPinchCollider
