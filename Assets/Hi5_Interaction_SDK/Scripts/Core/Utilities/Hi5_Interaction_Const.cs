...
namespace Hi5_Interaction_Core
{
    public class Hi5_Interaction_Const {
        ...
        public static float FingerPinchReleaseAngel = 140.0f;
        public static float FingerPalmPinchAngel = 100.0f;
        public static float FingerCollisionSaveTime = 0.4f;
        public static float FingerFlyPinchAngel = 125.0f;
        public static float PalmPinchFingerAngel = 120.0f;
        public static float FingerClapFourMinAngel = -15.0f;
        public static float FingerClapFourMaxAngel = 25.0f;
        public static float FingerClapThreeMinAngel = -15.0f;
        public static float FingerClapThreeMaxAngel = 13.0f;
        public static float FingerClapTwoMinAngel = -15.0f;
        public static float FingerClapTwoMaxAngel = 10.0f;
        public static float FingerPich2Release = 10.0f;
        public static float FingerColliderPinchPauseTime = 0.6f;
        public static float ThrowObjectProtecteionDistance = 0.055f;
        ...
        //释放权重值
        public static int ObjectPinchRecordPostionCount = 10;
       // public static int ObjectColliderRecordPostionCount = 5;
		...
		public static int OtherFingerSecondLayer()
		{
			return LayerMask.NameToLayer ("Hi5OtherFingerSecond");
		}
       ...
       // public static int PalmRigibodyLayer = 20;
        ...
        public static float FlyLiftPamlAngel = 25.0f;
        public static bool IsUseVisibleHand = false;
		public static float PlaneFrictionRateConst = 0.3f;
		//public static bool TestFlyMoveUsedGravity = false;
		//public static bool TestLift = true;
		public static bool TestPlaneStatic = true;
		public static bool TestChangeState = true;
		public static bool TestChangeState1 = false;
        ...
        public static float GetDistance(Transform palm, Hi5_Glove_Interaction_Item ObjectItem,out bool ContactIsSelf)
        {
            ...
            {
                if (hit.transform == ObjectItem.transform)
                {
                    ContactIsSelf = true;
